...
# USAGE: ./1_proteinOrthos2dnaOrthos_TA.py --input PATH2OrthoFiles --cdsFile PATH2combinedCDSfile
...
parser = argparse.ArgumentParser(description="This script extracts coding DNA sequences for the orthogroups generated by Orthofinder. The script assumes one-to-one relation between protein and cds files.")
